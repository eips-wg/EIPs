...
1. The first access to a slot in a block incurs the cold access cost as of [EIP-2929](./02929.md).
2. All subsequent accesses to the same slot within the same block incur only the warm access cost as of [EIP-2929](./02929.md).
