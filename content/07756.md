...
Format ([EIP-7692](./07692.md)) adds a number of features that need to be reflected in debugging
traces.
...
| `functionDepth` | Number               | Depth of the [EIP-4750](./04750.md) CALLF return stack |
...
- The `section` and `functionDepth` members were added to support [EIP-4750](./04750.md) EOF 
  Functions.
