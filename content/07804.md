...
[EIP-7685](./07685.md), decreasing the complexity of adding
...
| `WITHDRAWAL_CREDENTIALS_UPDATE_REQUEST_TYPE` | `0x03` | The [EIP-7685](./07685.md) type prefix for withdrawal credential update request |
...
The new withdrawal credential update request operation is an [EIP-7685](./07685.md) request
...
The [EIP-7685](./07685.md) encoding of a withdrawal credential update request is computed as follows.
