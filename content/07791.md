...
- Budget being 100% of the gas limit: 100% of the gas limit is a "natural" bound on the gas used and provides some protection to the user from unbounded `GAS2ETH` spending. In the future, a new [EIP-2718](./02718.md)-based transaction type could be added which includes an explicitly user-specified `GAS2ETH` budget.
