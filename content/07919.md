...
- [EIP-7708: ETH transfers emit a log](./07708.md)
- [EIP-7799: System logs](./07799.md)
...
- [EIP-7668: Remove bloom filters](./07668.md)
- [EIP-7745: Light client and DHT friendly log index](./07745.md)
- [EIP-7792: Verifiable logs](./07792.md) (alternative, with log index root provided via ZK instead of block header)
...
- [EIP-6404: SSZ transactions](./06404.md)
- [EIP-6466: SSZ receipts](./06466.md)
...
- [EIP-6465: SSZ withdrawals root](./06465.md)
- [EIP-7807: SSZ execution blocks](./07807.md)
...
- [EIP-7916: SSZ ProgressiveList](./07916.md)
- [EIP-7495: SSZ ProgressiveContainer](./07495.md)
