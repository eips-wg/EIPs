...
It depends on the two new opcodes proposed by [EIP-4200](./04200.md) to support static jumps:
...
In concert with [EIP-3540](./03540.md) and [EIP-3670](./03670.md) it ensures, at initialization time, that valid code will not execute invalid instructions or jump to invalid locations, will not underflow stack, will maintain consistent numbers of inputs and outputs for subroutines, and will have bounded stack height in the absence of recursion.
