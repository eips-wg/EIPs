...
while keeping the [Specification](../index.md#specification) section of the core document concise.
...
* **EIP-7701 Transaction**: the entire transaction initiated by the `Sender` Smart Contract Account and represented with
  an [EIP-2718](../../02718.md) compatible Transaction Envelope object.
...
1. Costs of the `SSTORE (0x55)` opcode per [EIP-2200](../../02200.md)
2. Costs of accessing cold addresses and slots per [EIP-2929](../../02929.md)
3. Values available within the transient storage per [EIP-1153](../../01153.md)
4. Maximum amount of gas refund assigned after the execution per [EIP-3529](../../03529.md)
