...
A more detailed motivation for this proposal can be found in the [README document](./assets/README.md).
...
A full list of rationales for the decisions made in this proposal can be found in the [README document](./assets/README.md).
