...
Let `INITCODE_WORD_COST` be 2 as defined in [EIP-3860](../03860.md).

The formula for determining the gas used per transaction changes from [EIP-7623](../07623.md)'s implementation to:
...
An empirical analysis summarizing the impact of this EIP can be found in [this](./assets/eip7976_empirical_analysis.md) report.
...
As the maximum possible block size is further reduced compared to [EIP-7623](../07623.md), no additional security concerns are introduced beyond those already addressed in the original proposal.

The same transaction bundling considerations from [EIP-7623](../07623.md) apply:
