...
This EIP is based on and tends to replace matter-labs' proposol for significant performance reasons. In most applications, BW6-761 is used as an outer curve to BLS12-377 considered in [EIP-2539](./02539.md).
...
Gas costs are based on [EIP-1962](./01962.md) estimation strategy (but do not fully include yet parsing of ABI, decoding and encoding of the result as a byte array).
