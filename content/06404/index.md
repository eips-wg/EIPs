...
This EIP defines a migration process of [EIP-2718](../02718.md) Recursive-Length Prefix (RLP) transactions to [Simple Serialize (SSZ)](https://github.com/ethereum/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/ssz/simple-serialize.md).
...
| - | - | - |
| `SECP256K1_ALGORITHM` | `uint8(0xFF)` | Defined from [EIP-7932](../07932.md) |

#### Verification

The `algorithm_registry` is defined from [EIP-7932](../07932.md) along with the `calculate_penalty` and `pubkey_to_address` functions.
...
| `ChainId` | `uint256` | [EIP-155](../00155.md) chain ID |
...
These transactions are locked to a single [EIP-155](../00155.md) chain ID.
...
These transactions support specifying an [EIP-2930](../02930.md) access list.
...
These transactions support specifying [EIP-1559](../01559.md) priority fees.
...
These transactions support specifying [EIP-4844](../04844.md) blobs.
...
These transactions support specifying an [EIP-7702](../07702.md) authorization list.
