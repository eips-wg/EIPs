...
This Meta EIP lists the EIPs included in the Dencun network upgrade across both Ethereum's execution and consensus layers. See [EIP-7568](./07568.md) for the specifications of past upgrades.

## Specification

### Included EIPs 

* [EIP-1153](./01153.md): Transient storage opcodes
* [EIP-4788](./04788.md): Beacon block root in the EVM
* [EIP-4844](./04844.md): Shard Blob Transactions 
* [EIP-5656](./05656.md): MCOPY - Memory copying instruction
* [EIP-6780](./06780.md): SELFDESTRUCT only in same transaction
* [EIP-7044](./07044.md): Perpetually Valid Signed Voluntary Exits
* [EIP-7045](./07045.md): Increase Max Attestation Inclusion Slot
* [EIP-7514](./07514.md): Add Max Epoch Churn Limit
* [EIP-7516](./07516.md): BLOBBASEFEE opcode
