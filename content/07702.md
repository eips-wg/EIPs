...
Add a new [EIP-2718](./02718.md) transaction type that allows Externally
...
transaction. One common example is an [ERC-20](./00020.md) approval followed by
...
A new [EIP-2718](./02718.md) transaction known as the "set code transaction"
...
transaction follow the same semantics as [EIP-4844](./04844.md). *Note, this
...
The [EIP-2718](./02718.md) `ReceiptPayload` for this transaction is
...
[EIP-3541](./03541.md), to indicate that the code must be handled differently
...
[EIP-2930](./02930.md), specifically `21000 + 16 * non-zero calldata bytes +
...
delegated code, add an additional [EIP-2929](./02929.md)
...
Modify the restriction put in place by [EIP-3607](./03607.md) to allow EOAs
...
calldata cost, plus the [EIP-3860](./03860.md) cost of `2 * 15 = 30`, plus
...
without over-enshrining any fine-grained details of [ERC-4337](./04337.md) or
RIP-7560.
...
[EIP-1559](./01559.md) transactions.
...
[ERC-7201](./07201.md) a contract may root its storage layout at a slot
