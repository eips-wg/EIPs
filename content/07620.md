...
- behavior on `accessed_addresses` and address collision is same as `CREATE2` (rules for `CREATE2` from [EIP-684](./00684.md) and [EIP-2929](./02929.md) apply to `EOFCREATE`)
