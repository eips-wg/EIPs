...
This EIP defines a migration process of [EIP-2718](./02718.md) Recursive-Length Prefix (RLP) receipts to [Simple Serialize (SSZ)](https://github.com/ethereum/consensus-specs/blob/b3e83f6691c61e5b35136000146015653b22ed38/ssz/simple-serialize.md)
...
2. **Unnecessary statefulness:** [EIP-658](./00658.md) replaced the intermediate post-state `root` from receipts with a boolean `status` code. However, `cumulativeGasUsed` and `logIndex` are similarly stateful, unnecessarily complicating efforts to execute transactions in parallel. Further, `gasUsed` verification requires computation from `cumulativeGasUsed` across multiple receipts.
...
| [`GasAmount`](./06404.md#normalized-transactions) | `uint64` |
...
- [`RlpLegacyReplayableBasicTransaction`](./06404.md#normalized-transactions)
- [`RlpLegacyBasicTransaction`](./06404.md#normalized-transactions)
- [`RlpAccessListBasicTransaction`](./06404.md#normalized-transactions)
- [`RlpBasicTransaction`](./06404.md#normalized-transactions)
- [`RlpBlobTransaction`](./06404.md#normalized-transactions)
...
- [`RlpLegacyReplayableCreateTransaction`](./06404.md#normalized-transactions)
- [`RlpLegacyCreateTransaction`](./06404.md#normalized-transactions)
- [`RlpAccessListCreateTransaction`](./06404.md#normalized-transactions)
- [`RlpCreateTransaction`](./06404.md#normalized-transactions)
...
- [`RlpSetCodeTransaction`](./06404.md#normalized-transactions)
...
| `status` | [EIP-658](./00658.md) transaction status code |
| `authorities` | For transactions with an authorization list, the list of [EIP-7702](./07702.md) `authority` addresses. Non-successful authorizations are represented with an all-zero address |
