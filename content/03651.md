...
But accessing `COINBASE` is overpriced; the address is initially cold under the access list framework introduced in [EIP-2929](./02929.md).
This gas cost mismatch can incentivize alternative payments besides ETH, such as [ERC-20](./00020.md), but ETH should be the primary means of paying for transactions on Ethereum.
