...
As per [EIP-7932](../07932.md), this EIP defines two Falcon algorithm types:
...
In the format of [EIP-7932](../07932.md):
...
**TBD by ACD.** Final precompile addresses will be selected within the EIP-managed range of [EIP-1352](../01352.md), explicitly **avoiding `0x0100–0x01FF` reserved for RIPs** by [EIP-7587](../07587.md).
