...
## Abstract
[Typed Transactions](./02718.md) can be sent over devp2p as `TransactionType || TransactionPayload`.
...
## Motivation
[EIP-2718](./02718.md) introduced new transaction types for blocks (which presents itself in the makeup of a block header's transaction root and receipts root).
...
*Note: See [EIP-2718](./02718.md) for additional motivations of Typed Transactions.*
