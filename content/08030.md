...
This EIP adds a new [EIP-7932](./07932.md) algorithm of type `0x0` for supporting P256 signatures.
...
cases against implementations of [EIP-7932](./07932.md).

## Specification

This EIP defines a new [EIP-7932](./07932.md) algorithmic type with the following parameters:
...
def gas_cost(signing_data: Bytes) -> Uint64:
    # This is the precompile cost from [EIP-7951](./07951.md) with 3000 gas
...
def validate(signature: Bytes) -> None | Error;
    ...
    # exposed function defined in [EIP-7951](./07951.md)
...
def verify(signature: Bytes, signing_data: Bytes) -> Bytes | Error;
    ...
    # This is similar to [EIP-2](./00002.md)'s malleability verification.
    assert(s <= N/2)
...
The `P256Verify` function is the logic of the precompile defined in [EIP-7951](./07951.md), the only exception is that this function MUST NOT charge any gas.
