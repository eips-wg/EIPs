...
This Meta EIP lists the EIPs Included in the Prague/Electra network upgrade. It follows the Dencun upgrade, documented in [EIP-7569](./07569.md).
...
* [EIP-7691](./07691.md): Blob throughput increase
* [EIP-7702](./07702.md): Set EOA account code

#### Other EIPs

* [EIP-7840](./07840.md): Add blob schedule to EL config files (Informational)
* [EIP-7642](./07642.md): eth/69 - Drop pre-merge fields (Networking)
