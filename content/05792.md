...
| 4001 | User Rejected Request | The user rejected submitting the batch of calls (from [EIP-1193](./01193.md)) | `wallet_sendCalls` |
| 4100 | Unauthorized | The specified address is not connected or not in the wallet (from [EIP-1193](./01193.md)) | `wallet_sendCalls`, `wallet_getCapabilities` |
