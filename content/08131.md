...
This EIP includes [EIP-7702](./07702.md) authorization data in the [EIP-7623](./07623.md) floor calculation, preventing circumvention of floor pricing through authorization lists.

## Motivation

[EIP-7702](./07702.md) authorization tuples are priced for execution (`PER_EMPTY_ACCOUNT_COST = 25,000` gas per authorization) but do not contribute to the [EIP-7623](./07623.md) floor calculation.
...
| `PER_EMPTY_ACCOUNT_COST` | `25000` | [EIP-7702](./07702.md) |

The [EIP-7623](./07623.md) floor calculation is modified to include authorization data:
...
- 101 bytes per authorization tuple (as specified in [EIP-7702](./07702.md))
...
Authorization costs are added to the floor calculation only, not to intrinsic gas. This differs from [EIP-7981](./07981.md) (access lists) because:
...
This EIP closes a loophole that allows circumventing [EIP-7623](./07623.md) floor pricing. Without this fix, adversaries can achieve ~9% larger blocks by combining calldata with authorization data.

### Interaction with EIP-7981

If [EIP-7981](./07981.md) is also adopted, both EIPs work together: access list tokens and authorization tokens are both included in the floor calculation. There are no conflicts.
