...
The files [BlackScholes.yul](./assets/BlackScholes.yul) and [Neuron.yul](./assets/Neuron.yul) demonstrate how these OPCODEs simplify numerical smart contract code.
