...
1. Update the [EIP-170](./00170.md) contract code size limit of 24KiB (`0x6000` bytes) to 32KiB (`0x8000` bytes).
2. Update the [EIP-3860](./03860.md) initcode size limit of 48KiB (`0xC000` bytes) to 64KiB (`0x10000` bytes).
