...
![deposit tree evolution](./assets/deposit_tree_evolution.svg)
...
Test cases are included in [test_cases.yaml](./assets/test_cases.yaml). Each case is structured as follows:
...
* [deposit_snapshot.py](./assets/deposit_snapshot.py) contains the same code as the [Reference Implementation](#reference-implementation)
* [eip_4881.py](./assets/eip_4881.py) contains boilerplate declarations
* [test_deposit_snapshot.py](./assets/test_deposit_snapshot.py) includes code for running test cases against the reference implementation
