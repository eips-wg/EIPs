...
This EIP adds a new [EIP-7932](./07932.md) algorithm of type `0x0` for supporting Ed25519 signatures.
...
cases against during the implementation phase of [EIP-7932](./07932.md).
...
This allows it to be an algorithm for client teams to easily test [EIP-7932](./07932.md).

It may also be useful for signing in Hardware security modules in server environments designed for serving
as [ERC-4337](./04337.md) bundlers. It may also improve interoperability with other components such as TPM chips.
