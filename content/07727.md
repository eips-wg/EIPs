...
Two new [EIP-2718](./02718.md) transactions with types `DELEGATED_TX_TYPE` and `BUNDLE_TX_TYPE`.
...
For `DELEGATED_TX_TYPE` transaction that are able to begin execution, their [EIP-2718](./02718.md) receipt payload should be interpreted as:
...
The `BUNDLE_TX_TYPE` transaction’s  [EIP-2718](./02718.md) receipt payload should be interpreted as:
