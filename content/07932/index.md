...
An example of this specification can be found [here](./assets/template-eip.md).
...
Test cases for the `sigrecover` precompile may be found in the [precompile_test_cases.py](./assets/precompile_test_cases.py) file.
