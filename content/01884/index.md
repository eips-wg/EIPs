...
![bars1](./assets/run3.total-bars-5.png) 
![bars2](./assets/run3.total-bars-6.png) 
...
![geth](./assets/geth_processing.png)
...
`EXTCODEHASH` was introduced in Constantinople, with [EIP-1052](../01052.md). It was priced at `400` with the reasoning:
...
- Contracts that assume a certain fixed gas cost for calls (or internal sections) may cease to function.
  - A fixed gas cost is specified in [ERC-165](../00165.md) and implementations of this interface do use the affected opcodes.
