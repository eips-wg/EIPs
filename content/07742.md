...
Update blob maximum and target verification from [EIP-4844](./04844.md).
...
The protocol also maintains an [EIP-1559](./01559.md)-like "target" value for an intended running average amount of blob throughput per
