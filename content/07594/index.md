...
DAS is a method of scaling data availability beyond the levels of [EIP-4844](../04844.md) by not requiring all nodes to download all data while still ensuring that all of the data has been made available.
...
This EIP is fully backwards compatible with [EIP-4844](../04844.md).
...
![withholding-probability](./assets/withholding-probability.svg)
